...
class CategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
            ...
            return Datatables::of($category)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    <li class="data-table-list-item list-group-item border-0 p-0 bg-transparent">
                        <a href="' . route('admin.categories.category.show', $row->id) . '" class="edit d-flex align-items-center gap-2 text-dark">
                    ...
                    <li class="data-table-list-item list-group-item border-0 p-0 bg-transparent">
                        <a href="' . route('admin.categories.category.edit', $row->id) . '" class="edit d-flex align-items-center gap-2 text-info">
                ...
                ->addColumn('featured_image', function ($image) {
                    $url = asset("assets/admin/uploads/category/$image->featured_image");
        ...
        return view(self::CATEGORY_INDEX_PATH);
    }
    ...
    public function store(AdminCategoryCreateRequest $request)
    {
        ...
        $categories = $this->categoryRepository->createCategory($categoryDetails);
        ...
        */
        if ($request->hasFile('featured_image')) {
            ...
            $imageName = uploadImages($image, '/assets/admin/uploads/category');
            $categories->featured_image = $imageName;
        }
        //image upload ends

        $categories->save();

        return redirect()->route(self::CATEGORY_INDEX_PATH);
    }
    ...
    public function update(AdminCategoryUpdateRequest $request, $id)
    {
        ...
        $categoriesUpdate = $this->categoryRepository->updateCategory($id, $updatedDetails);
        ...
        if ($request->hasFile('featured_image')) {
            $image = $request->file('featured_image');
            $imageName = uploadImages($image, '/assets/admin/uploads/category');
            $categoriesUpdate->featured_image = $imageName;
        }
        //image upload ends
