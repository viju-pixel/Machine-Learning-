...
use App\Http\Requests\AdminCountryCreateRequest;
use App\Http\Requests\AdminCountryUpdateRequest;
...
class CountryController extends Controller
{
    ...
    const COUNTRY_INDEX_PATH = 'admin.user-management.country.index';   // to remove duplicity of index route or view
    ...
    public function index(Request $request)
    {
                ...
                ->addColumn('action', function ($row) {
                    ...
                    '<ul class="data-table-list list-group list-group-horizontal gap-3 justify-content-between">
                        <li class="data-table-list-item list-group-item border-0 p-0 bg-transparent">
                            <a href="' . route('admin.user-management.country.show', $row->id) . '" class="edit d-flex align-items-center gap-2 text-dark">
                        ...
                        <li class="data-table-list-item list-group-item border-0 p-0 bg-transparent">
                            <a href="' . route('admin.user-management.country.edit', $row->id) . '" class="edit d-flex align-items-center gap-2 text-info">
        ...
        return view(self::COUNTRY_INDEX_PATH);
    }
    ...
    {
        return view('admin.user-management.country.create');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(AdminCountryCreateRequest $request)
    {
        ...
        return redirect()->route(self::COUNTRY_INDEX_PATH);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.user-management.country.show', compact('country'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.user-management.country.edit', compact('country'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(AdminCountryUpdateRequest $request, $id)
    {
        $updatedCountryDetails = $request->only([
            'iso',
            'name',
            'nice_name',
            'iso3',
        ...
        $this->countryRepository->updateCountry($id, $updatedCountryDetails);
