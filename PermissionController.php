...
class PermissionController extends Controller
{
    ...
    const PERMISSION_INDEX_PATH = 'admin.user-management.permissions.index';   // to remove duplicity of index route or view
    ...
    public function index(Request $request)
    {
                ...
                ->addColumn('action', function ($row) {
                    return '<ul class="data-table-list list-group list-group-horizontal gap-3 justify-content-between">
                        <li class="data-table-list-item list-group-item border-0 p-0 bg-transparent">
                            <a href="' . route('admin.user-management.permissions.show', $row->id) . '" class="edit d-flex align-items-center gap-2 text-dark">
                        ...
                        <li class="data-table-list-item list-group-item border-0 p-0 bg-transparent">
                            <a href="' . route('admin.user-management.permissions.edit', $row->id) . '" class="edit d-flex align-items-center gap-2 text-info">
        ...
        return view(self::PERMISSION_INDEX_PATH);
    }
    ...
    public function store(PermissionCreateRequest $request)
    {
        ...
        return redirect()->route(self::PERMISSION_INDEX_PATH);
    }
